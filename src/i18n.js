export const dict = {
  "it": {
    ...
    "i_hours": "Orari",
    "clocks_title": "Orari nel mondo",
    "clocks_sub": "Aggiornato in tempo reale",
    "clocks_base": "Base operativa: Milano",
    "clocks_local": "Il tuo orario locale",
  ...
  "en": {
    ...
    "i_area": "Service area",
    "i_hours": "Hours",
    "clocks_title": "World clocks",
    "clocks_sub": "Updated in real time",
    "clocks_base": "Operating base: Milan",
    "clocks_local": "Your local time",
  ...
  "ar": {
    ...
    "i_area": "منطقة الخدمة",
    "i_hours": "ساعات العمل",
    "clocks_title": "التوقيت حول العالم",
    "clocks_sub": "يتحدّث في الوقت الفعلي",
    "clocks_base": "قاعدة العمل: ميلانو",
    "clocks_local": "توقيتك المحلي",
